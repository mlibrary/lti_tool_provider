...
class LTIToolProviderTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\Core\TempStore\PrivateTempStore|\PHPUnit_Framework_MockObject_MockObject
   */
  protected $tempStore;
  ...
  public function appliesProvider() {
    return [
      ...
      'get request' => [FALSE, Request::create('/lti', 'GET', [
      ...
      'LTI-1p0 request' => [TRUE, Request::create('/lti', 'POST', [
        'oauth_consumer_key' => 'oauth_consumer_key',
        'lti_message_type' => 'basic-lti-launch-request',
        'lti_version' => 'LTI-1p0',
        'resource_link_id' => 'resource_link_id',
      ...
      'LTI-1p2 request' => [TRUE, Request::create('/lti', 'POST', [
        'oauth_consumer_key' => 'oauth_consumer_key',
        'lti_message_type' => 'basic-lti-launch-request',
        'lti_version' => 'LTI-1p2',
        'resource_link_id' => 'resource_link_id',
      ...
      'missing resource link request' => [FALSE, Request::create('/lti', 'POST', [
        'oauth_consumer_key' => 'oauth_consumer_key',
        'lti_message_type' => 'basic-lti-launch-request',
        'lti_version' => 'LTI-1p0',
      ]),
      ],
      'empty resource link request' => [FALSE, Request::create('/lti', 'POST', [
        'oauth_consumer_key' => 'oauth_consumer_key',
        'lti_message_type' => 'basic-lti-launch-request',
        'lti_version' => 'LTI-1p0',
        'resource_link_id' => '',
      ...
      'missing oauth consumer key request' => [FALSE, Request::create('/lti', 'POST', [
        'lti_message_type' => 'basic-lti-launch-request',
        'lti_version' => 'LTI-1p0',
        'resource_link_id' => 'resource_link_id',
      ]),
