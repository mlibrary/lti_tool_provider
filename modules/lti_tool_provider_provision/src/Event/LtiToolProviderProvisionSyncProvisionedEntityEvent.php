...
class LtiToolProviderProvisionSyncProvisionedEntityEvent extends LtiToolProviderEvent
{
    const EVENT_NAME = 'LTI_TOOL_PROVIDER_PROVISION_SYNC_PROVISIONED_ENTITY_EVENT';
