 ...
 */
class V1p3LtiToolProviderRolesSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId(): string {
    return 'v1p3_lti_tool_provider_roles_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $filter = ''): array {
    ...
    $mapped_roles = $settings->get('v1p3_mapped_roles');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $settings->set('v1p3_mapped_roles', $mapped_roles);
