...
/**
 * Implementation V1p3LtiToolProviderAttributesSettingsForm class.
 *
 * @package Drupal\lti_tool_provider_attributes\Form
 */
class V1p3LtiToolProviderAttributesSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId(): string {
    return 'v1p3_lti_tool_provider_attributes_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $filter = ''): array {
    ...
    $mapped_attributes = $settings->get('v1p3_mapped_attributes');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $settings->set('v1p3_mapped_attributes', $mapped_attributes);
